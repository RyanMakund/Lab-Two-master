...
public:
	...
	friend std::ostream& operator<<(std::ostream& out, const WorkTicket& work_ticket);

	friend std::istream& operator>>(std::istream& in, WorkTicket& work_ticket);
...
std::ostream& operator<<(std::ostream& out, const WorkTicket& work_ticket)
{
	out << work_ticket.ToString();
	return out;
}

std::istream& operator>>(std::istream& in, WorkTicket& work_ticket)
{
